class StochasticActivationPruning(nn.Module):
    ...
    """
    def __init__(self, ratio=1.2, is_valid=False):
        """
        Parameters
        ----------
...
class BasicBlockSAP(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.sap = StochasticActivationPruning(is_valid=True)
...
class ResNetSAP(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.sap1 = StochasticActivationPruning(is_valid=True)
...
def ResNet18SAP():
    return ResNet(BasicBlockSAP, [2, 2, 2, 2])        
